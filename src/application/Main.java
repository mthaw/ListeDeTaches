 ...
 * 
 * 2. L'application priorise aussi les sessions de travail de l'usager selon la duree de temps de la session, entr� par l'usager. L'ensemble de taches a completer durant la session (c-ad la somme du temps requise de tout les taches doit etre inferieure ou egal au duree de la session), qui maximizent l'utilisation du temps / la productivite (c-ad qui a la somme maximale de valeurs/importance) sont affiches dans un tableau. Ces taches sont a completer pendant la session.
 * 
 * 3. Finalement, l'application permet de presenter a l'usager, leur flux de travail / charge de travail, en representant le nombre de taches due � chaque jour pendant une semaine, sur une graphique a barres.
 */
